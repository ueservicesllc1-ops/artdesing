    ...
    return (
        <div className="auth-container fade-in">
            <div className="auth-card">
                ...
                {resetSent && <div className="success-message">Email de recuperacion enviado. Revisa tu bandeja.</div>}
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="btn btn-accent btn-lg" type="submit" style={{ width: '100%' }} disabled={loading}>
